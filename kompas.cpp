...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
    ...
    if( hwnd == NULL )
    {
        MessageBox( NULL, "Błąd w generowaniu okna", "No cóż...", MB_ICONEXCLAMATION );
        return 1;
    }
    ...
    break;
     ...
     case WM_PAINT:
        ...
        SelectObject( hdc, PenBlack );
			...
			LineTo(hdc,30,300); //narysowanie linni do współrzędnej (100,100)
